...
QFlashcard v3 prepares the project for Quasar CLI Vite 3. The app extension is Vite-only, requires `@quasar/app-vite` >=3.0.0-beta.44, and no longer supports webpack-based Quasar apps.
