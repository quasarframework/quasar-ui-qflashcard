...
export default {
  api: {
    entries: [
      {
        docsUrl: '/developing/using-qflashcard',
        input: 'packages/ui/src/components/QFlashcard.ts',
        output: 'packages/ui/dist/api/QFlashcard.json',
      },
      {
        docsUrl: '/developing/using-qflashcard',
        input: 'packages/ui/src/components/QFlashcardSection.ts',
        output: 'packages/ui/dist/api/QFlashcardSection.json',
      },
    ],
  },
  check: {
