...
import markdown from '../markdown/flashcard.md'
import Api from '@quasar/quasar-ui-qflashcard/dist/api/QFlashcard.json'
import Api2 from '@quasar/quasar-ui-qflashcard/dist/api/QFlashcardSection.json'
