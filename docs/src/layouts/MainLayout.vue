    ...
    >
      <q-toolbar>
        <div class="full-width text-center">
          This documentation site for QFlashcard is a work in progress. If you see something missing or inaccurate, please create a PR on the <markdown-link
            to="https://github.com/quasarframework/quasar-ui-qflashcard/tree/next"
            style="color: white;"
          >
            GitHub repo
          </markdown-link>.
