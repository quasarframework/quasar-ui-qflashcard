...
const menu = [
  {
    name: 'All about QFlashcard',
    path: 'all-about-qflashcard',
    expanded: false,
    children: [
      {
        name: 'What is QFlashcard',
        path: 'what-is-qflashcard'
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        name: 'Using QFlashcard',
        path: 'using-qflashcard'
      }
    ]
  },
  {
    ...
    children: [
      {
        name: 'GitHub',
        external: true,
        path: 'https://github.com/quasarframework/quasar-ui-qflashcard',
        rightIcon: biGithub
      },
      {
        name: 'Twitter',
