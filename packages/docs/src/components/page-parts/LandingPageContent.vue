<template>
  <section class="landing-page markdown-brand">
    <header class="hero">
      <img src="/app-logo-128x128.png" alt="QFlashcard Logo" class="hero-logo" />
      <h1 class="hero-title">QFlashcard</h1>
      ...
      <div class="hero-buttons">
        ...
        <a
          href="https://github.com/quasarframework/quasar-ui-qflashcard/tree/v3-beta"
          target="_blank"
    ...
    <div class="byline">
      <p>
        Add compact flashcard transitions to Quasar applications with hover-driven or explicitly
        controlled animated panels.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qflashcard" target="_blank">
          QFlashcard GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QFlashcard repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
