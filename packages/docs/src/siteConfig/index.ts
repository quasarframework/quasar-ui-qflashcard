  ...
  children: [
    {
      name: 'GitHub',
      icon: fabGithub,
      path: `https://github.com/quasarframework/quasar-ui-qflashcard/tree/${repoBranch}`,
      external: true,
    },
    {
      name: 'X (Twitter)',
...
const docsMenus: SiteMenuItem[] = [
  ...
  },
  {
    ...
    mq: 1000,
    children: [
      { name: 'Using QFlashcard', path: '/developing/using-qflashcard' },
...
const config: SiteConfig = {
  lang: 'en-US',
  title: productName,
  description: 'CSS transition flashcards for Vue and Quasar applications',
  version,
  copyright: {
  ...
  codepen: {
    ...
    cssExternal: [
      `https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qflashcard@${codepenPackageVersion}/dist/index.min.css`,
    ],
    jsExternal: [
      `https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qflashcard@${codepenPackageVersion}/dist/index.umd.min.js`,
    ],
    globalPackages: [
      {
